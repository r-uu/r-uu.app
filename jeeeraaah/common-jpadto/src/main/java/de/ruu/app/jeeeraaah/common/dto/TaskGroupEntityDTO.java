				...
				TaskGroupEntity<TaskEntityDTO>
{
	...
	@Override public void beforeMapping(@NonNull TaskGroupEntityJPA input) { }
	@Override public void afterMapping (@NonNull TaskGroupEntityJPA input) { }

	@Override public @NonNull TaskGroupEntityJPA toSource() { return Mapper.INSTANCE.map(this); }
