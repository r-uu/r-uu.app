...
public class TaskDTO extends AbstractMappedDTO<TaskEntity> implements Task
{
	...
	@Override
	public @NonNull Optional<Task> parent() { return Optional.ofNullable(parent); }
...
//	public void      setParent(          TaskDTO  parent)          { parent         (parent);           }
	...
	public @NonNull Optional<Set<TaskDTO>> optionalPredecessors()
	{
	...
	/** @return optional unmodifiable */
	public @NonNull Optional<Set<TaskDTO>> optionalSuccessors()
	{
	...
	/** @return optional unmodifiable */
	public @NonNull Optional<Set<TaskDTO>> optionalChildren()
	{
