...
//	private UUID            uuid = new UUID();
	...
	@Override
	@NonNull
	public Optional<TaskEntity> optionalParent() { return Optional.ofNullable(parent); }
...
//	@Nullable
//	public TaskEntity getParent()                                    { return          optionalParent;            }
//	public void       setParent(         TaskEntity optionalParent)          { optionalParent         (optionalParent);           }

	///////////////////////
	// additional accessors
	///////////////////////
	/** @return optional unmodifiable */
	public Optional<Set<TaskEntity>> optionalPredecessors()
	{
	...
	/** @return optional unmodifiable */
	public Optional<Set<TaskEntity>> optionalSuccessors()
	{
	...
	/** @return optional unmodifiable */
	public Optional<Set<TaskEntity>> optionalChildren()
	{
