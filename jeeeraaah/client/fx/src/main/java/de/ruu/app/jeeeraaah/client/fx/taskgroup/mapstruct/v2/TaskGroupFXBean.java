...
public class TaskGroupFXBean
		implements
				...
				BiMappedFXTarget<de.ruu.app.jeeeraaah.client.fx.taskgroup.mapstruct.TaskGroupBean>
{
...
//	}
	...
	@BeforeMapping public void beforeMapping(@NonNull de.ruu.app.jeeeraaah.client.fx.taskgroup.mapstruct.TaskGroupBean source)
	{
		id      = source.id     ();
	...
	public void afterMapping (@NonNull de.ruu.app.jeeeraaah.client.fx.taskgroup.mapstruct.TaskGroupBean source) { }
