...
//	}
	...
	public void beforeMapping(@NonNull TaskBean source)
	{
		...
		taskGroupProperty.setValue(Map_TaskGroup_Bean_FXBean.INSTANCE.map(source.taskGroup()));
		...
		source.parent         ().ifPresent(t -> parentProperty.setValue(Map_Task_Bean_FXBean.INSTANCE.map(t)));
	...
	@NonNull public TaskBean toBean() { return Map_Task_Bean_FXBean.INSTANCE.map(this); }
